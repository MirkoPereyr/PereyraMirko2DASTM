...
namespace Ejercicio04 {
    ...
    public partial class dsCrud : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductosRow AddProductosRow(string nombre, decimal precio) {
...
namespace Ejercicio04.dsCrudTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Productos] WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND" +
                " [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_precio = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Productos] ([nombre], [precio]) VALUES (@nombre, @precio);\r\nSELECT i" +
                "d, nombre, precio FROM Productos WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Productos] SET [nombre] = @nombre, [precio] = @precio WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_precio = 1 AND [precio] IS NULL) OR ([precio] = @Original_precio)));
SELECT id, nombre, precio FROM Productos WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ejercicio04.Properties.Settings.Default.CrudWindowsFormConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "insert into Productos(nombre, precio)\r\nvalues (@nombre, @precio)";
            ...
            this._commandCollection[2].CommandText = "UPDATE Productos set nombre=@nombre,precio=@precio where id=@id";
            ...
            this._commandCollection[3].CommandText = "select * from Productos \r\nwhere id=@id";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM Productos where id=@id";
        ...
        public virtual int Fill(dsCrud.ProductosDataTable dataTable) {
        ...
        public virtual dsCrud.ProductosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCrud.ProductosDataTable dataTable = new dsCrud.ProductosDataTable();
        ...
        public virtual int FillBy(dsCrud.ProductosDataTable dataTable, int id) {
        ...
        public virtual dsCrud.ProductosDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            dsCrud.ProductosDataTable dataTable = new dsCrud.ProductosDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCrud.ProductosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, global::System.Nullable<decimal> Original_precio) {
        ...
        public virtual int Insert(string nombre, global::System.Nullable<decimal> precio) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, global::System.Nullable<decimal> precio, int Original_id, string Original_nombre, global::System.Nullable<decimal> Original_precio, int id) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, global::System.Nullable<decimal> precio, int Original_id, string Original_nombre, global::System.Nullable<decimal> Original_precio) {
        ...
        public virtual int Add(string nombre, global::System.Nullable<decimal> precio) {
        ...
        public virtual int Edit(string nombre, global::System.Nullable<decimal> precio, int id) {
